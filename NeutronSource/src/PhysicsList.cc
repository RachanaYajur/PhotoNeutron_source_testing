 ...
 fDecay(nullptr), fRadioactiveDecay(nullptr)
{
  ...
  //Shielding Physics
  //fShielding = new G4PhysListFactory::GetReferencePhysList("ShieldingLEND");
  //fShielding = new Shielding(verb,"LEND");
  //RegisterPhysics(fShielding);
  ...
  //fGammaNuclear = new G4BertiniElectroNuclearBuilder(verb);
  //fGammaNuclear = new G4LENDBertiniGammaElectroNuclearBuilder(verb);
  RegisterPhysics(fGammaNuclear);

  // EM physics
  fElectromagnetic = new ElectromagneticPhysics();
//  fElectromagnetic = new G4EmStandardPhysics();
  fElectromagneticExtra = new G4EmExtraPhysics();
  RegisterPhysics(fElectromagnetic);
  RegisterPhysics(fElectromagneticExtra);
